<template>
  <div class="pui-operation-delete" v-loading="loading">
    <div class="content">
  ...
  created() {
    if (this.editRow) {
      ...
      operationService
        ...
        .then(data => {
          this.form.batchType = this.editRow.batchType;
          this.form.batchUpdateViewId = this.editRow.batchUpdateViewId;
          this.form.description = this.editRow.description;
          this.form.flag = this.editRow.flag;
          this.form.flushType = this.editRow.flushType;
          this.form.followType = this.editRow.followType;
          this.form.forwardVid = this.editRow.forwardVid;
          this.form.iconClass = this.editRow.iconClass;
          this.form.moduleId = this.editRow.moduleId;
          this.form.operationName = this.editRow.operationName;
          this.form.operationPosition = this.editRow.operationPosition;
          this.form.operationType = this.editRow.operationType;
          this.form.ruleId = this.editRow.ruleId;
          this.form.sort = this.editRow.sort;
          this.form.status = this.editRow.status;
          this.form.submitDataType = this.editRow.submitDataType;
          this.form.submitType = this.editRow.submitType;
          this.form.submitUrl = this.editRow.submitUrl;
          this.form.type = this.editRow.type;
          this.form.viewId = this.editRow.viewId;
