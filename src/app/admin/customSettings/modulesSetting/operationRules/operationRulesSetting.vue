<template>
  <div class="pui-operation-rules-setting">
    <pui-container class="pui-operation-rules-setting__container">
      <pui-aside width="300px" class="pui-operation-rules-setting__aside" :style="{ minHeight: (rulesSettingHeight+'px') }">
        <div class="pui-operation-rules-setting__left">
      ...
      <pui-main  class="pui-operation-rules-setting__main">
        <div class="pui-operation-rules-setting__right">
    ...
    <pui-operation-rules-edit v-if="showEditDialog" :editRow="editRow" :isEdit="isEdit" :viewId="query.viewId" :currentModuleId="currentModuleId" @getTableData="getTableData" @closeDialog="handleCloseEdit"></pui-operation-rules-edit>
  </div>
</template>
<script>
import puiOperationRulesEdit from "./operationRulesEdit";
import { operationRuleService } from "paas-web-utils/services";
export default {
  name: "PuiOperationRulesSetting",

  components: {
    puiOperationRulesEdit
  },
  ...
  methods: {
    ...
    getTableData(params) {
      ...
      params.viewId && operationRuleService.findOperationRuleByPage(params).then(data => {
...
@import "./operationRulesSetting.scss";
