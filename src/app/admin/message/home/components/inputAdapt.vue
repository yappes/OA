<template>
  <div>
    ...
    <file-upload v-else-if='type==="FILEUPLOAD"' v-model='model' :accept='accept' :action='action' :multiple='multiple' ></file-upload>
  </div>
</template>
  
<script>
import userSelection from './user-selection-format'
