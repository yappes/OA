...
export default {
  ...
  created(){
    ...
    switch(this.viewType){
      case 'add' : this.viewTypes = [1,5];
        break;
      case 'addModule' : this.viewTypes = [1,4,5];
        break;
      case 'batchCtrl' : this.viewTypes = [1,5];
        break;
      ...
      case 'edit' : this.viewTypes = [1,4,5];
        break;
      case 'processSubmit' : this.viewTypes = [1,2,3,4,5];
        break;
      case 'submit' : this.viewTypes = [1,2,3,4,5];
        break;
      case 'submitConfirm' : this.viewTypes = [1,4,5];
        break;
    }
  },
  watch:{
