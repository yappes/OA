<template>
  <div class="pui-pagination" v-if='pageCount>0'>
    <aui-button class="pui-pagination__first pg" @click="handleFirst" :disabled='currentPage<=1'>首页</aui-button>
    ...
    <aui-button class="pui-pagination__last pg" @click="handleLast" :disabled='currentPage>=pageCount'>尾页</aui-button>
