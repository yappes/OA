<template>
  <div class="pui-editPage">
    <pui-layout>
      ...
      <pui-btns-top slot="topBar" ref="btnsTop" :operations="view.operations" back is-watch-scroll @button-click="buttonClick"></pui-btns-top>
      <div slot="main">
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      this.$set(
        this.scrollData,
        "topHeight",
        this.$refs.btnsTop.$el.offsetHeight
      );
